...
*per-table* basis in `AequilibraE's documentation <https://www.aequilibrae.com/%%folder%%/python/modeling_with_aequilibrae/transit_database/data_model/datamodel.html>`_, 
