...
*per-table* basis in `AequilibraE's documentation <https://www.aequilibrae.com/dev/python/modeling_with_aequilibrae/transit_database/data_model/datamodel.html>`_, 
